...
-- Datos de prueba para base de datos de Servicios Web
-- Motor esperado: MySQL/MariaDB
-- Incluye mas de 15 registros para demostracion.
...
INSERT IGNORE INTO Ubicaciones (id_ubicacion, nombre_ubicacion, descripcion) VALUES
(1, 'Campus Central', 'Ubicación general dentro del campus universitario.'),
(2, 'Facultad de Ingeniería', 'Zona de Ingeniería dentro del campus universitario.'),
(3, 'Biblioteca Central', 'Zona de biblioteca central y áreas de estudio.');

INSERT IGNORE INTO Locales (id_local, nombre_local, ubicacion, descripcion, estado, imagen_uri) VALUES
...
VALUES
(1, 'Administrador Sistema', 'admin@ues.edu.sv', SHA2('Admin123', 256), 'AD00001', 2, 1, NULL, 1),
(2, 'Encargado Cafetín', 'encargado@ues.edu.sv', SHA2('Encargado123', 256), 'EN00001', 3, 1, 1, 1),
(3, 'Maria Lopez', 'maria.lopez@ues.edu.sv', SHA2('Usuario123', 256), 'ML23001', 1, 2, NULL, 1),
(4, 'Carlos Perez', 'carlos.perez@ues.edu.sv', SHA2('Usuario123', 256), 'CP23002', 1, 3, NULL, 1);
...
INSERT IGNORE INTO OpcionesMenu
...
INSERT IGNORE INTO Roles_OpcionesMenu (id_rol_opcion, id_rol, id_opcion) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 4),
...
INSERT IGNORE INTO Detalle_Pedido
...
INSERT IGNORE INTO Pedidos_Especiales
...
VALUES
(1, 4, 'Refrigerio para jornada académica de Ingeniería', '2026-05-30', '09:00:00', 12, 15.00, 25.00, 5.00, 'ANT-0004');
